/*********************************************************************************************************************
 ...
 The Die class presented in Listing 5.2 of the textbook models a standard cubic die with faces 1 through 6.
 It is also possible to have regular dice with 4 sides (tetrahedron), 8 sides (octahedron),
 12 sides (dodecahedron), and 20 sides (icosahedron).

 Modify the Die class so that it can be used to simulate any of the five possible regular dice.
 The class requires the following methods and/or modifications:
    ...
    The setFaceValue() method needs to have logic added to ensure the new incoming face value is within
    the allowable limits for the number of faces.
