/*********************************************************************************************************************
 ...
 Hints: Remember that a vertical number line has a zero position in the middle with positive to the top and negative to the bottom.
 It is your design choice whether the monkey will jump onto the vine in the middle or at some random point between two limits.

 Write an interactive test driver that instantiates a Monkey, then allows the user to manipulate it with simple commands
 like Output (to see the position and direction), Climb, Reverse, Exit ... single letters work just fine.
 All output must be via the driver not methods within Monkey.
 You should use this driver to create screenshot exhibits for a number of scenarios (e.g. output original state,
 climb a few times, output, climb a few more times, output, reverse, output, climb, output, reverse, output, etc.).
 *********************************************************************************************************************/
